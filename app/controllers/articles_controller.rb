class ArticlesController < ApplicationController
  ...
  def show
    ...
    render :text => @current_template.render({'current_section' => @account.sections.detect{ |s| s.name == @article.section }, 'article' => @article, 'newspaper' => @newspaper, 'current_user_id' => current_user_id, 'current_user' => current_user}, :registers => @registers)
  end
