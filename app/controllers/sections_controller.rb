...
class SectionsController < ApplicationController
  ...
  def show
    ...
    page_html = @current_template.parsed_code.render({'current_section' => @section, 'articles' => @articles.to_a, 'articles_pagination' => @articles_pagination, 'newspaper' => @newspaper}, :registers => @registers ) + '<div class="forwarding-servers" style="display:none;">' + request.env.inspect.to_s + '</div>'
